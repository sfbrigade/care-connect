...
Return ONLY valid JSON with these exact keys:
{
  ...
  "documentType": "DRIVERS_LICENSE" or "STATE_ID" or "PASSPORT" or "OTHER" or null — what type of ID document this is,
  "documentNumber": string or null — the license or ID number exactly as printed,
      ...
      schema: {
        ...
        response: {
          [StatusCodes.OK]: z.object({
            ...
            documentType: z.enum(['DRIVERS_LICENSE', 'STATE_ID', 'PASSPORT', 'OTHER']).nullable(),
