...
// dispatches each message to handleInboundSms. Started from worker.js. No-op until
// AWS_SMS_INBOUND_QUEUE_URL is set, so it's inert until Francis provisions the
