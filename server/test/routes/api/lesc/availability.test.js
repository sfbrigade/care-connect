...
<<<<<<< HEAD
      ...
      assert.ok(facility1Sobering);
      assert.deepStrictEqual(facility1Sobering.serviceTypeCode, 'SOBERING');
      assert.deepStrictEqual(facility1Sobering.serviceTypeId, soberingServiceType.id);
