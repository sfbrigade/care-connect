...
const Api = {
    ...
    deflections: {
        ...
        detailCategories: {
            index() {
                return instance.get('/api/deflections/detail-categories');
            },
            get(id) {
                return instance.get(`/api/deflections/detail-categories/${id}`);
            },
            create(data) {
                return instance.post('/api/deflections/detail-categories', data).catch(handleError);
            },
            update(id, data) {
        ...
        details: {
            ...
            reopen(id) {
                return instance.patch(`/api/deflections/details/reopen/${id}`).catch(handleError);
            },
            delete(id) {
