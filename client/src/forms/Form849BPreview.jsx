...
export default function Form849BPreview () {
  ...
  const downloadPdf = () => {
    if (pdfUrl) {
      ...
      link.href = pdfUrl;
      link.download = `849b-report-${deflectionId}.pdf`;
      link.click();
    }
  };
    ...
    return (
      <Container size='md' py='xl'>
        <Group mb='lg'>
          ...
          <Title order={2}>PC 849(b) Report</Title>
        </Group>
      ...
      <Stack gap='md'>
        {!isReleased(deflection) && (
          <Alert icon={<IconInfoCircle size={16} />} color='yellow' title='Subject not yet released'>
            The 849(b) Report can only be generated after the subject has been released.
        ...
        <Paper shadow='sm' p='md' withBorder>
          <Group justify='space-between' align='center'>
            <Group gap='sm'>
              ...
              <div>
                <Text fw={500}>Generate PC 849(b) Report</Text>
                <Text size='sm' c='dimmed'>
                  SFSD PC 849(b) Report for {subjectName}
                </Text>
              </div>
            </Group>
            <Group>
