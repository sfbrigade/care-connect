  ...
  return (
    <Container size='xl'>
      <Grid>
        <Grid.Col span={4}>
          <MantineNavLink
            component={NavLink} to='/admin/enums/deflection-cancel-reasons'
            label='Arrest Cancel Reasons' rightSection={<IconChevronRight />}
          />
          <MantineNavLink
            component={NavLink} to='/admin/enums/facility-status-reasons'
            label='Facility Status Reasons' rightSection={<IconChevronRight />}
          />
          <MantineNavLink
            component={NavLink} to='/admin/enums/deflection-details-categories'
            label='Detail Categories' rightSection={<IconChevronRight />}
          />
          <MantineNavLink
            component={NavLink} to='/admin/enums/deflection-details'
