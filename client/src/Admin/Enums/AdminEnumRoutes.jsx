...
function AdminEnumsRoutes () {
  return (
    <Container size='xl'>
      <Grid>
        <Grid.Col span={4}>
          <MantineNavLink component={NavLink} to='/admin/enums/deflection-cancel-reasons' label='Custodial Arrest Cancel Reasons' rightSection={<IconChevronRight />} />
        ...
        <Grid.Col span={8}>
          <Routes>
            ...
            <Route path='' element={<Navigate to='facility-status-reasons' />} />
          </Routes>
        </Grid.Col>
      </Grid>
    </Container>
